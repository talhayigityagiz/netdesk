  ...
  Widget theme() {
    ...
    return _Card(title: 'Theme', children: [
      _Radio<String>(context,
          ...
          groupValue: current,
          label: 'Light',
          onChanged: isOptFixed ? null : (val) => onChanged(val as String)),
      _Radio<String>(context,
          value: 'dark',
          groupValue: current,
          label: 'Dark',
...
class _AboutState extends State<_About> {
  ...
  Widget build(BuildContext context) {
    return futureBuilder(future: () async {
      ...
      return SingleChildScrollView(
        controller: scrollController,
        child: _Card(title: translate('About NetDesk'), children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SizedBox(
...
class _WaylandCardState extends State<WaylandCard> {
  ...
  //   "Settings" -> "Apps" -> "NetDesk" -> "Permissions" -> "Inhibit Shortcuts".
  // For resetting(clearing) the permission from the portal permission store, you can
  // use (replace <desktop-id> with the NetDesk desktop file ID):
  ...
  // the exported desktop ID derived from the Flatpak app-id (e.g. "com.rustdesk.NetDesk.desktop").
  //
