...
class PlatformFFI {
  ...
  NetdeskImpl get ffiBind => _ffiBind;
  ...
  Future<void> init(String appType) async {
    ...
    final dylib = isAndroid
        ? DynamicLibrary.open('netdesk.so')
        : isLinux
            ? DynamicLibrary.open('netdesk.so')
            : isWindows
                ? DynamicLibrary.open('netdesk.dll')
                :
                ...
                //
                // isMacOS? DynamicLibrary.open("libnetdesk.dylib") :
  ...
  void _startListenEvent(NetdeskImpl rustdeskImpl) {
    final appType =
